<template>
  <div class="container mt-4">
    ...
    <div class="row">
      <div class="col-md-4" v-for="vendor in filteredItems" v-bind:key="vendor._id" >
        <div class="card mb-4 box-shadow my-4">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <button type="button" class="btn btn-sm btn-outline-secondary" v-on:click="viewVendor(vendor)">View</button>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  created: function() {
    ...
    this.$http
      .get("/api/vendors/vendorType/" + this.$props._id)
      .then(response => {
  ...
  methods: {
    viewVendor: function(vendor) {
      this.$router.push({
        name: "vendor-profile",
        params: {
          vendorId: vendor._id,
          typeId: vendor.type._id
        }
      });
    }
  },
